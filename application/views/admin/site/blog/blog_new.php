...
<form class="form-horizontal" action="<?=ROOT?>admin/blog/news-sm/<?=isset($data['id'])?$data['id']:''?>" method="post" target="main" enctype="multipart/form-data">
  ...
  <div class="form-group">
    ...
    <div class="col-lg-6">
      <div class="fileupload fileupload-new" data-provides="fileupload"><input type="hidden" value="" name="">
          <div class="fileupload-new thumbnail" style="width: 200px; height: 150px;"><img src="<?=isset($data['id'])?ROOT.'upload/post/450/'.$data['image']:PUB.'assets/img/demoUpload.jpg'?>" alt=""></div>
